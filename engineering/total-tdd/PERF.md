# total-tdd Performance

## Measured Skills
- Detection benchmark: total-tdd arena eval (N=8; k=1 single run; models: codex / baseline, codex / with-skill).
...
|---|---:|---:|---:|
| codex / baseline | 8/8 | 100% | 0 |
| codex / with-skill | 8/8 | 100% | 0 |
